...
public:
    ...
    virtual std::vector<MeshPositionVertexBuffersResponse> getSkeletalMeshPositionVertexBuffers(const std::string& object_name, bool forceOwnerHasOwner) const override;
